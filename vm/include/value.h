...
#define IS_NTV_FUN(val) (val.type == T_NTV_FUN)
#define IS_NTV_PTR(val) (val.type == T_NTV_PTR)
...
#define NTV_FUN_VAL(x)                                                                             \
  (Value) {                                                                                        \
    .type = T_NTV_FUN, .as.native = x                                                              \
  }
#define NTV_PTR_VAL(x)                                                                             \
  (Value) {                                                                                        \
    .type = T_NTV_PTR, .as.native = x                                                              \
  }
