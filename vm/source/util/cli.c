...
bool param(const char *arg) { return strncmp(arg, "-", 1) == 0; }

bool param_opt_get(int opt) { return parameter_options_bits & opt; }

void param_opt_set(int opt) { parameter_options_bits |= opt; }
