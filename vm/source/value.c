...
bool truthy(Value v) {
  switch (v.type) {
    ...
    case T_NTV_FUN: return true;
    case T_NTV_PTR: return true;
  }
}
...
bool equal_values(Value a, Value b) {
  ...
  switch (a.type) {
    ...
    case T_NTV_FUN: return a.as.native == b.as.native;
    case T_NTV_PTR: return a.as.native == b.as.native;
...
void print_value(Value v) {
  switch (v.type) {
    ...
    case T_NTV_FUN: PRINT_BR("{native-fun}");
    case T_NTV_PTR: PRINT_BR("{native-ptr}");
    case T_OBJ:
      printf("obj = ");
