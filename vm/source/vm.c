  ...
  switch (TUP(a.type, b.type)) {
    ...
    case TUP(T_OBJ, T_STR): {
      if (IS_OBJ_STR(a) && IS_STR(b)) {
        Object* obj = (Object*)obj_str_concat(OBJ_STR(a.as.object)->data, b.as.string);
    ...
    case TUP(T_OBJ, T_OBJ): {
      if (IS_OBJ_STR(a) && IS_OBJ_STR(b)) {
        Object* obj =
          (Object*)obj_str_concat(OBJ_STR(a.as.object)->data, OBJ_STR(b.as.object)->data);
...
static inline Value divide_(VM* vm, Value a, Value b) {
  switch (TUP(a.type, b.type)) {
    ...
    case TUP(T_STR, T_STR): {
      Object* obj = (Object*)obj_str_concat_sep(a.as.string, PATH_SEPARATOR, b.as.string);
    ...
    case TUP(T_OBJ, T_STR): {
      ...
      Object* obj =
        (Object*)obj_str_concat_sep(OBJ_STR(a.as.object)->data, PATH_SEPARATOR, b.as.string);
...
static inline Value append_(VM* vm, Value a, Value b) {
  ...
  if (IS_OBJ_ARR(a) && IS_OBJ_ARR(b)) {
    Object* obj = (Object*)obj_arr_concat(OBJ_ARR(a.as.object), OBJ_ARR(b.as.object));
