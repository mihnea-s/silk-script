...
typedef enum {
  ...
  VM_INT, // push 8 byte integer
  VM_REA, // push 8 byte real
  VM_CHR, // push 4 byte unicode char
  ...
  VM_GET,  // load symbol (byte address)
  VM_GET2, // 2 byte address
  VM_GET3, // 3 byte address
  VM_GET4, // 4 byte address
