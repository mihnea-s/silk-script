#include <silk/compiler/mothvm.h>
...
auto CompilerMothVM::emit(std::uint8_t byte) -> void {
  if (_targets.empty()) {
...
auto CompilerMothVM::emit_arg(std::uint32_t arg, std::size_t size) -> void {
...
auto CompilerMothVM::emit_op_arg(std::uint8_t base_op, std::uint32_t id)
  -> void {
...
auto CompilerMothVM::get_offset() -> std::uint32_t {
  if (_targets.empty()) {
    return _program.len;
  } else {
...
auto CompilerMothVM::get_buffer() -> std::uint8_t * {
  if (_targets.empty()) {
...
auto CompilerMothVM::push_scope() -> void {
  if (_targets.empty()) {
    _main_locals.depth++;
  } else {
...
auto CompilerMothVM::pop_scope() -> void {
  auto &locals = [&]() -> auto & {
    if (_targets.empty()) {
      _main_locals.depth--;
      return _main_locals;
...
auto CompilerMothVM::load_constant(std::int64_t value) -> void {
...
auto CompilerMothVM::load_constant(double value) -> void {
...
auto CompilerMothVM::load_constant(char32_t value) -> void {
...
auto CompilerMothVM::load_constant(std::string_view str) -> void {
...
auto CompilerMothVM::load_identifier_val(
  const st::Node &node, std::string_view name) -> void {
...
auto CompilerMothVM::load_identifier_ref(
  const st::Node &node, std::string_view name) -> void {
  // ! URGENT: This function needs implementation
...
auto CompilerMothVM::define_stack_var(std::string_view name, bool immut)
  -> bool {
...
auto CompilerMothVM::get_stack_var(std::string_view name)
...
auto CompilerMothVM::load_stack_var(std::uint16_t slot) -> void {
  emit(VM_PSH);
  emit_arg(slot, 2);
}

auto CompilerMothVM::store_stack_var(std::uint16_t slot) -> void {
  emit(VM_STR);
  emit_arg(slot, 2);
}

auto CompilerMothVM::encode_rodata(Value value) -> std::uint32_t {
  return write_rodata(&_program, value);
}

auto CompilerMothVM::load_rodata(std::uint32_t id) -> void {
  emit_op_arg(VM_VAL, id);
}

auto CompilerMothVM::encode_symbol(std::string_view str) -> std::uint32_t {
...
auto CompilerMothVM::define_symbol(std::uint32_t id) -> void {
  emit_op_arg(VM_DEF, id);
}

auto CompilerMothVM::load_symbol(std::uint32_t id) -> void {
  emit_op_arg(VM_SYM, id);
}

auto CompilerMothVM::assign_symbol(std::uint32_t id) -> void {
  emit_op_arg(VM_ASN, id);
}

auto CompilerMothVM::jmp_insert(std::uint8_t jmp_type) -> std::uint32_t {
  // Emit the jmp byte
  emit(jmp_type);
...
auto CompilerMothVM::jmp_finish(std::uint32_t insc) -> void {
  ...
  // in `CompilerMothVM::jmp_insert`
  get_buffer()[insc - 1] = (jmp_size >> 0) & 0xff;
  get_buffer()[insc - 2] = (jmp_size >> 8) & 0xff;
}

auto CompilerMothVM::logical_or(st::Node &left, st::Node &right) -> void {
  handle_node(left);
...
auto CompilerMothVM::logical_and(st::Node &left, st::Node &right) -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::Comment &) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::ModuleMain &) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::ModuleDeclaration &) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::ModuleImport &) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::DeclarationFunction &) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::DeclarationEnum &) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::DeclarationObject &) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::DeclarationDynamicLibrary &)
  -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::DeclarationMacro &) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::StatementEmpty &) -> void {
  emit(VM_NOP);
}

auto CompilerMothVM::handle(st::Node &node, st::StatementExpression &data)
  -> void {
  handle_node(*data.child);
  emit(VM_POP);
}

auto CompilerMothVM::handle(st::Node &node, st::StatementBlock &data) -> void {
  push_scope();
...
auto CompilerMothVM::handle(st::Node &node, st::StatementCircuit &) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::StatementVariable &data)
  -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::StatementConstant &) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::StatementReturn &data) -> void {
  handle_node(*data.child);
  emit(VM_RET);
}

auto CompilerMothVM::handle(st::Node &node, st::StatementSwitch &data) -> void {
  emit(VM_RET);
}

auto CompilerMothVM::handle(st::Node &node, st::StatementIterationControl &data)
  -> void {
  // TODO
}

auto CompilerMothVM::handle(st::Node &node, st::StatementIf &data) -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::StatementWhile &data) -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::StatementLoop &) -> void {
  // TODO
}

auto CompilerMothVM::handle(st::Node &node, st::StatementFor &) -> void {
  // TODO
}

auto CompilerMothVM::handle(st::Node &node, st::StatementForeach &) -> void {
  // TODO
}

auto CompilerMothVM::handle(st::Node &node, st::StatementMatch &) -> void {
  // TODO
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionIdentifier &data)
  -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::ExpressionVoid &data) -> void {
  emit(OpCode::VM_VID);
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionContinuation &data)
  -> void {
  emit(OpCode::VM_VID);
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionBool &data) -> void {
  // There exist VM instructions for pushing boolean true and false
  emit(data.value ? VM_TRU : VM_FAL);
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionNat &data) -> void {
  // load_constant(data.value);
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionInt &data) -> void {
  load_constant(data.value);
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionReal &data) -> void {
  load_constant(data.value);
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionRealKeyword &data)
  -> void {
  switch (data.kind) {
...
auto CompilerMothVM::handle(st::Node &node, st::ExpressionChar &data) -> void {
  load_constant(data.value);
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionString &data)
  -> void {
  load_constant(data.value);
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionTuple &data) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionUnaryOp &data)
  -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::ExpressionBinaryOp &data)
  -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::ExpressionRange &data) -> void {
}

auto CompilerMothVM::handle(st::Node &node, st::ExpressionVector &data)
  -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::ExpressionArray &data) -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::ExpressionDictionary &data)
  -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::ExpressionAssignment &data)
  -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::ExpressionCall &data) -> void {
...
auto CompilerMothVM::handle(st::Node &node, st::ExpressionLambda &data)
  -> void {
...
auto CompilerMothVM::add_breakpoint(size_t) noexcept -> void {
}

auto CompilerMothVM::add_breakpoint(std::string) noexcept -> void {
}

auto CompilerMothVM::execute(Package &&pkg) noexcept -> Program {
